...
var KeyboardClass = __webpack_require__(11);

var CommandsClass = __webpack_require__(14);

//Add Event Listener For When User Press Enter

document.addEventListener("terminal:submit", function (e) {

    Command.execute(e.detail);
});

document.addEventListener("terminal:load", function (e) {
...
document.addEventListener("terminal:exit", function () {

    document.querySelector(".terminalMsgWrapper:nth-child(3)").style.display = "flex";
});

document.addEventListener("terminal:failed", function (e) {
...
var Keyboard = new KeyboardClass(config.wrapperId);

var Command = new CommandsClass(config.serverAddress, config.api, config.wrapperId);
...
var beep = __webpack_require__(13);

var Keyboard = function () {
        function Keyboard(wrapperId) {
                var _this = this;
                ...
                window.onkeypress = function (e) {
                        ...
                        if (e.keyCode == 13) {
                                ...
                                if (_this.wrapper.querySelector("[data-active=true]").className.split(" ").includes("userPartialInput")) {
                                        var terminalSubmitEvent = new CustomEvent("terminal:submitPartial", { detail: _this.wrapper.querySelector("[data-active=true]>.contentOfTheLine").innerText });
                                        document.dispatchEvent(terminalSubmitEvent);
                                } else {

                                        //add event to the history

                                        _this.History.add(_this.wrapper.querySelector("[data-active=true]>.contentOfTheLine").innerText);

                                        var _terminalSubmitEvent = new CustomEvent("terminal:submit", { detail: _this.wrapper.querySelector("[data-active=true]>.contentOfTheLine").innerText });
                                        document.dispatchEvent(_terminalSubmitEvent);
                                }
                        } else {
                ...
                document.addEventListener("paste", function (e) {
                        _this.type(e.clipboardData.getData("text/plain"));
                });
                                ...
                                if (_this.keypress) {
                                        ...
                                        switch (e.key.toLowerCase()) {
                                                ...
                                                case "a":
                                                        ...
                                                        break;
                                                case "arrowup":
                                                        _this.typeSen(_this.History.prevHistory());
                                                        break;
                                                case "arrowdown":
                                                        _this.typeSen(_this.History.nextHistory());
                                                        break;
                                        }
                                }
                        }, 20);
        ...
        _createClass(Keyboard, [{
                key: "type",
                value: function type(char) {

                        var activeLine = this.wrapper.querySelector("[data-active=true]>.contentOfTheLine");
                ...
                value: function backSpace() {
                        ...
                        var temp = activeLine.innerText.split("");
...
var Commands = function () {
    function Commands(serverAddress, api, wrapperId) {
        ...
        var terminalLoadEvent = new Event("terminal:load");
    ...
    _createClass(Commands, [{
        key: "execute",
        value: async function execute(commandText) {
            var _this = this;

            this.logger._commitUserInput();

            var commandName = this._getCommandName(commandText).toLowerCase();
            ...
            if (command = this._findOrFail(commandName)) {
                ...
                if (this._countParameters(commandText) != this._countRequiredParameters(command[commandName])) {
                    //some parameters are missing!

                    var requiredParametersLength = this._countRequiredParameters(command[commandName]);

                    var parametersLength = this._countParameters(commandText);

                    for (var i = 0; i < requiredParametersLength - parametersLength; i++) {

                        var item = this._getCommandByIntIndex(command[commandName], i + parametersLength);
                ...
                if (commandName == "login") {
                    var commandObj = this._getFormData(commandText, command[commandName]);
                    this._processLogin(commandObj, command);
                    return;
                } else if (commandName == "logout") {
                    var _commandObj = this._getFormData(commandText, command[commandName]);
                    this._processLogout(_commandObj, command);
                    return;
                }

                if (command.method.toLowerCase() == "get") {

                    var _commandObj2 = this._getCommandObject(commandText, command[commandName]);
                    ...
                    axios({
                        ...
                        _this.logger.success(result.text);
                        _this.logger._reGenerateUserInput();
                        ...
                        _this.logger.error(result);
                        _this.logger._reGenerateUserInput();
                    });
                } else {

                    var _commandObj3 = this._getFormData(commandText, command[commandName]);

                    axios.post(command.url, _commandObj3).then(function (result) {
                        result = JSON.parse(result);
                        _this.logger.success(result.text);
                        _this.logger._reGenerateUserInput();
                    }).catch(function (result) {
        ...
        key: "_defaultCommands",
        value: function _defaultCommands(commandName) {
        ...
        key: "_getCommandName",
        value: function _getCommandName(commandText) {
            var commandName = "";
        ...
        key: "_getCommandByIntIndex",
        value: function _getCommandByIntIndex(command, num) {
        ...
        key: "_processLogin",
        value: function _processLogin(commandObj, command) {
            var _this2 = this;
            ...
            axios.post(command.url, commandObj).then(function (result) {
                result = result.data;

                _this2._login(result.username, result.api);

                _this2.logger.success("You Have Logged In! Welcome <b>" + result.username + "</b>!");
                _this2.logger._reGenerateUserInput();
            }).catch(function (result) {
                result = result.data;
                if (typeof result === "undefined") {
                    result = "Unknown Error!";
                ...
                _this2.logger.error(result);
                _this2.logger._reGenerateUserInput();
            });
        }
    }, {
        key: "_processLogout",
        value: function _processLogout() {
        ...
        key: "_login",
        value: function _login(username, api) {
            this.auth = true;
        ...
        key: "_needsHelp",
        value: function _needsHelp(commandText) {
        ...
        key: "_showHelp",
        value: function _showHelp(command, commandName) {
            ...
            for (var item in command[commandName]) {
        ...
        key: "_showAllCommands",
        value: function _showAllCommands() {
            ...
            try {
                for (var _iterator = this.commands[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    for (var commandName in item) {
                        if (_typeof(item[commandName]) == "object") {
                            var helpText = commandName;
                            for (var param in item[commandName]) {
        ...
        key: "_getFormData",
        value: function _getFormData(commandText, command) {
            ...
            try {
                for (var _iterator2 = commandText[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var _item = _step2.value;

                    if (this.optionalParamRegex.test(_item)) {
                        var matches = this.optionalParamRegex.exec(_item);
        ...
        key: "_getCommandObject",
        value: function _getCommandObject(commandText, command) {
            ...
            try {
                for (var _iterator3 = commandText[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    var _item2 = _step3.value;

                    if (this.optionalParamRegex.test(_item2)) {
                        var matches = this.optionalParamRegex.exec(_item2);
        ...
        key: "_countParameters",
        value: function _countParameters(commandText) {
            var _this3 = this;

            var newCmd = commandText.split(" ").filter(function (item) {
                return !_this3.optionalParamRegex.test(item) && item.trim() != "";
            });
            return newCmd.length - 1;
        }
    }, {
        key: "_countRequiredParameters",
        value: function _countRequiredParameters(command) {
        ...
        key: "_findOrFail",
        value: function _findOrFail(command) {
            command = command.toLowerCase();
            var commandObj = this.commands.filter(function (item) {
                return item[command];
            });
...
var Logger = function () {
        ...
        _createClass(Logger, [{
                ...
                key: "getParameter",
                value: function getParameter(paramName) {
                        var _this = this;

                        return new Promise(function (resolve) {

                                _this._generatePartialUserInput(paramName);

                                document.addEventListener("terminal:submitPartial", function (e) {
                ...
                value: function clear() {
                        ...
                        var elems = this.wrapper.querySelectorAll(".line");
                ...
                key: "_commitUserInput",
                value: function _commitUserInput() {

                        var currUserInput = document.querySelector("#" + this.wrapperId + ">[data-active=true]");
                ...
                key: "_reGenerateUserInput",
                value: function _reGenerateUserInput() {
                        ...
                        var contentOfTheLineElement = document.createElement("span");
                ...
                key: "_generatePartialUserInput",
                value: function _generatePartialUserInput(message) {
